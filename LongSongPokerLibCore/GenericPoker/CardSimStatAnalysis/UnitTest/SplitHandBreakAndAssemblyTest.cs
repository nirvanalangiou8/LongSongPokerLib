...
namespace GenericPoker.CardSimStatAnalysis.UnitTest
{
    ...
    public class SplitHandBreakAndAssemblyTest
    {
        ...
        [TestCase("ThreeCardsFlushStraight_ThreeOfKind", "[ThreeOfKind,ThreeCardsFlushStraight]")]
        [TestCase("FourOfKind", "[Nothing,FourOfKind]")]
        [TestCase("ThreeOfKind*2", "[ThreeOfKind,ThreeOfKind]")]
        ...
        [TestCase("SixCardsFlushStraight", "[Nothing,SixCardsFlushStraight]")]
        ...
        [TestCase("SixCardsFlushStraight_Pair", "[Pair,SixCardsFlushStraight]")]
        ...
        [TestCase("SevenCardsFlushStraight", "[Nothing,SevenCardsFlushStraight]")]
        ...
        [TestCase("EightCardsFlushStraight", "[Nothing,EightCardsFlushStraight]")]
        ...
        [TestCase("ThreeCardsFlushStraight_ThreeOfKind*2", "")]
        [TestCase("ThreeCardsFlushStraight*2_ThreeOfKind", "")]
        [TestCase("FourCardsFlushStraight*2", "[FourCardsFlushStraight,FourCardsFlushStraight]")]
        [TestCase("FourOfKind_ThreeCardsFlushStraight_Pair", "[Mansion,FourOfKind]")]
        [TestCase("SevenCardsFlushStraight", "[Nothing,SevenCardsFlushStraight]")]
        [TestCase("ThreeOfKind*3", "")]
        [TestCase("FourOfKind_FourCardsFlushStraight", "[FourCardsFlushStraight,FourOfKind]")]
        [TestCase("ThreeCardsFlushStraight*3", "")]
        [TestCase("FourOfKind*2", "[FourOfKind,FourOfKind]")]
        [TestCase("NineCardsFlush", "[Nothing,NineCardsFlush]")]
        [TestCase("SevenCardsFlushStraight_Pair", "[Pair,SevenCardsFlushStraight]")]
        [TestCase("FiveCardsFlushStraight_FourCardsFlushStraight", "[FourCardsFlushStraight,FiveCardsFlushStraight]")]
        [TestCase("SixCardsFlushStraight_ThreeOfKind", "[ThreeOfKind,SixCardsFlushStraight]")]
        ...
        [TestCase("NineCardsFlushStraight", "[Nothing,NineCardsFlushStraight]")]
